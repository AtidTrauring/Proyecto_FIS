...
public class JFSacar extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addComponent(jlnuevosaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(52, 52, 52)
                        .addComponent(jlsaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jlnuevosaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jlsaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jBContinuarSacarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBContinuarSacarActionPerformed
        ...
        // Validar el valor de "Retiro" usando la función validaRetiro
        String r = jtfretirar.getText();
        if (!cmensajes.validaRetiro(r)) {
            return; // Si la validación de retiro falla, no sigue con el proceso
        }
        // Validación para verificar si jlsaldo está vacío
        if (jlsaldo.getText().isEmpty()) {
            cmensajes.mistake("No se encontró saldo disponible", "Campo vacío");
            return; // Sale del método si jlsaldo está vacío
        }
        ...
        try {
            ...
            if (retiro > saldo) {
                cmensajes.mistake("Saldo INSUFICIENTE", "Insuficiente");
            } else {
                resto = saldo - retiro;
                nuevosaldo = Double.toString(resto);
                jlnuevosaldo.setText(nuevosaldo);
                System.out.println(resto);
                cmensajes.message("Retiro EXITOSO", "Retiro");
            }
        } catch (NumberFormatException e) {
            // Capturar errores si los valores ingresados no son números válidos
