...
public class JfCredito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlvalidacurp = new javax.swing.JLabel();
        ...
        jlvalidacurp.setForeground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(jpbusquedaLayout.createSequentialGroup()
                .addGroup(jpbusquedaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpbusquedaLayout.createSequentialGroup()
                        ...
                        .addComponent(jlvalidacurp, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jpbusquedaLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jpbusquedaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jpbusquedaLayout.setVerticalGroup(
            ...
            .addGroup(jpbusquedaLayout.createSequentialGroup()
                .addGroup(jpbusquedaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpbusquedaLayout.createSequentialGroup()
                        .addGap(143, 143, 143)
                        .addComponent(jlvalidacurp, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jpbusquedaLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLInstruccionCre)
    ...
    private void jbbuscarcurpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbbuscarcurpActionPerformed
        ...
        try {
            if (!curp.isEmpty()) {
                cmensajes.validaCURP(curp, jlvalidacurp);
                ...
                jlvalidacurp.setText("Ingresa algo");
            }
        } catch (SQLException ex) {
            Logger.getLogger(JfCredito.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.JLabel jlvalidacurp;
