                ...
                .addGroup(JpnlLienzoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(JpnlLienzoLayout.createSequentialGroup()
                        ...
                        .addGroup(JpnlLienzoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTFApellidoM, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jBRegistrarmeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBRegistrarmeActionPerformed
        try {
            if (validaCampos() && sonIguales()) {
                ...
                if (curp == null) {
                    cmensajes.message("A continuación agregue su dirección \n Por favor", "Registro Usuario");
